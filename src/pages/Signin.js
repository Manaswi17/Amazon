        ...
        <div className='w-full  bg-white pb-10'>
            <form className='w-[350px] mx-auto flex flex-col items-center'>
               ...
               <p className='text-xs text-black leading-4 mt-4'>By Continuinig, you agree to Amazon's 
                ...
                <button 
                className='w-full py-1.5 mt-4 text-sm font-normal rounded-sm bg-gradient-to-t from-slate-200 to-slae-100 hover:bg-gradieny-to-b border border-zinc-400 active:border-yellow-800 active-shadow-amazonInput'>
