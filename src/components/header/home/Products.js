    ...
    <div className='max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 xl:gap-10 px-4'>
      {
        ...
        <div key={item.id}className='bg-white h-auto border-[1px] border-gray-200 py-8 z-30 hover:border-transparent shadow-none hover:shadow-testShadow duration-200 flex flex-col gap-4 relative'>
          ...
          <ul className='w-full h-36  bg-gray-100 absolute bottom-[-150px] flex flex-col items-end justify-center gap-2 font-titleFont px-1 border-2 border-r group-hover:bottom-0 duration-700'>
          ...
          <div className='px-4 z-10 h-36 bg-white'>
          ...
          <div className='text-yellow-500 py-5'>
            <StarIcon />
            <StarIcon />
            <StarIcon />
            <StarIcon />
